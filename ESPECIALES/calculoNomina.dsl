...
[keyword][]SUELDO=(pago.getTabSueldo()/2.0 * 2.0 - pago.montoConceptoRetroactivo("P","07") - pago.montoConceptoRetroactivo("P","02"))
[keyword][]COMPENSACION=(pago.getTabCompensacion()/2.0 * 2.0 - pago.montoConceptoRetroactivo("P","06"))
...
[keyword][]MONTO_PREST_FIJAS=(292.5 * 2.0 - pago.montoConceptoRetroactivo("P","44") - pago.montoConceptoRetroactivo("P","46") - pago.montoConceptoRetroactivo("P","38"))
[keyword][]MONTO_AYUDA_DESPENSA=(392.5 * 2.0 - pago.montoConceptoRetroactivo("P","38"))
[keyword][]MONTO_PREVISION_SOCIAL=(292.5 * 2.0 - pago.montoConceptoRetroactivo("P","44"))
[keyword][]MONTO_AYUDA_SERVICIOS=(282.5 * 2.0 - pago.montoConceptoRetroactivo("P","46"))
[keyword][]MONTO_AYUDA_TRANSPORTE=(300.0 * 2.0 - pago.montoConceptoRetroactivo("P","95"))
[keyword][]COMP_X_DESA=(800.0 * 2.0 - pago.montoConceptoRetroactivo("P","77"))
[keyword][]PRIMA_QUIN_A1=(80.0 * 2.0 - pago.montoConceptoRetroactivo("P","A1"))
[keyword][]PRIMA_QUIN_A2=(92.5 * 2.0 - pago.montoConceptoRetroactivo("P","A2"))
[keyword][]PRIMA_QUIN_A3=(117.5 * 2.0 - pago.montoConceptoRetroactivo("P","A3"))
[keyword][]PRIMA_QUIN_A4=(130.0 * 2.0 - pago.montoConceptoRetroactivo("P","A4"))
[keyword][]PRIMA_QUIN_A5=(142.5 * 2.0 - pago.montoConceptoRetroactivo("P","A5"))
...
[keyword][]AYUDA_DESP=(392.5 * 2.0 - pago.montoConceptoRetroactivo("P","38"))
[keyword][]MONTO_SEGURO_COLECTIVO_PAR=(7.28  * 2.0 - pago.montoConceptoRetroactivo("D","77"))
[keyword][]MONTO_SEGURO_COLECTIVO_MES=(7.275 * 2.0 - pago.montoConceptoRetroactivo("D","77"))
...
[keyword][]MONTO_SEG_FOV=(8.50 * 2.0  - pago.montoConceptoRetroactivo("D","68"))
...
[keyword][]TOPE_SDO_BASE=pago.sueldoBase(12673.50 * 2.0)
[keyword][]GRAVABLE=pago.getAcumuladoGravable()
[keyword][]MONTO_SEG_SEP=((pago.getTabSueldo() + pago.getTabCompensacion()) * pago.porcentajeConcepto("D","82") / 100.00 /2.0 * 2.0 - pago.montoConceptoRetroactivo("D","82"))
...
[keyword][]MONTO_SEGURO_COLECTIVO_NON=(7.27 * 2.0 - pago.montoConceptoRetroactivo("D","77"))
...
[keyword][]SUELDO_HONORARIO=pago.getTabSueldoPre()/2.0 * 2.0
[keyword][]COMPENSACION_HONORARIO=(pago.getImpHonorario()/2.0 - pago.getTabSueldoPre()/2.0) * 2.0
...
[keyword][]GRAVABLE_SEG_SEP=(pago.getTabSueldo() + pago.getTabCompensacion()) / 2.0 * 2.0
...
[keyword][]GRAVABLE_OPERATIVO=((pago.getTabSueldo() + pago.getTabCompensacion() + pago.getIncentivo()) / 2.0  + 800.0 + 192.5 + 392.5 + 282.5 + 300.0) * 2.0
...
[keyword][]TOPE_SDO_BASE_PATRON=pago.sueldoBasePatron(12673.50 * 2.0)
...
[keyword][]SDO_BASE_PATRON=(pago.sueldoBasePatron(12673.50 * 2.0 + 1))
